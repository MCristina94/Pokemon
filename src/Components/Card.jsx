    ...
    <div className="">
      <div className="p-5 h-96 w-64 bg-white m-10 rounded-xl">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <button className="mb-2 rounded-full border border-blue-900 px-4 hover:bg-blue-900 hover:text-white" onClick={pokemonStorage}>I Chose You</button>
          <Link to={'/detail/' + props.id}>
          <button className="mb-2 rounded-full border border-blue-900 px-4  hover:bg-blue-900 hover:text-white">Learn More</button>
          </Link>
        </div>  
      </div>
